...
no_button.addEventListener('click', () => {
    ...
    size += sizes[random]
    yes_button.style.minHeight = `${size}px`;
    yes_button.style.minWidth = `${size}px`;
    // Scale font size proportionally with button size (base size is 16px at 40px button height)
    const fontSize = (size / 40) * 16;
    ...
    if (i < total - 1) {
        ...
        yes_button.style.minHeight = "";
        yes_button.style.minWidth = "";
